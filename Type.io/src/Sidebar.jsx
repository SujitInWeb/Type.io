export default function Sidebar({ setActiveMode }) {
  return (
    <div className="w-[300px] h-screen flex items-center flex-col p-7 bg-[#010409]">
      ...
      <button 
        className="bg-[#0D1117] text-lg text-[#F0F6FC] min-w-full p-3 border rounded-lg border-[#3D444D] my-2 hover:border-[#3D444D] hover:bg-[#F0F6FC] hover:text-[#0D1117] cursor-pointer transition duration-280"
