  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={toggleTheme}
          className="bg-gray-800/50 dark:bg-white/50 hover:bg-gray-800/80 dark:hover:bg-white/80 text-white dark:text-[#0D1117] lg:text-lg md:text-lg text-sm font-[Roboto] min-w-full p-3 border rounded-lg border-gray-300 dark:border-[#3D444D] my-2 cursor-pointer transition duration-280 flex items-center justify-center gap-2"
        >
          {isDarkMode ? (
            <>
